        ...
        statistics: {
            ...
            action: function(result, $this){
                if (result.result){
                    ...
                    $('#totalSites').text(result.total.sites);
                    $('#totalPages').text(result.total.pages);
                    $('#totalLemmas').text(result.total.lemmas);
                    $('select[name="site"] option').not(':first-child').remove();
                    result.detailed.forEach(function(site){
